...
const HistorySection: React.FC<HistorySectionProps> = ({
  ...
  const timeline = [
    {
      ...
      description: "El día que el destino nos regaló nuestra primera cita y comenzó nuestra historia.",
      icon: StarsIcon,
      accent: "#e8748a",
    ...
    },
    {
      ...
      event: "Octubre, 2025",
      description: "Bailamos bajo las estrellas y supimos que queríamos esto para siempre.",
      icon: HeartIcon,
      accent: "#b8843a",
  ...
  const handlePrev = () => {
    const i = (currentImageIndex - 1 + currentEventImages.length) % currentEventImages.length;
    setCurrentImageIndex(i);
    setSelectedImage(currentEventImages[i]);
  };
    ...
    <>
      ...
      <Box sx={{
        ...
        {[0,1,2,3].map((i) => (
          <Box key={i} sx={{
            position: "absolute",
            top: i < 2 ? 52 : "auto", bottom: i >= 2 ? 12 : "auto",
            left: i % 2 === 0 ? 12 : "auto", right: i % 2 === 1 ? 12 : "auto",
            width: 52, height: 52, opacity: 0.14, pointerEvents: "none",
        ...
        <Box sx={{ px: { xs: 3, sm: 5 }, py: { xs: 4, sm: 5 } }}>
          ...
          {/* ── Header ── */}
          <Box className="hs-reveal hs-reveal-1" sx={{ textAlign: "center", mb: 4 }}>
            <Box sx={{
              ...
              <HeartIcon sx={{ fontSize: 34, color: T.rose, animation: "hs-pulse 2.2s infinite" }} />
            </Box>

            <Typography sx={{ ...serifFont, fontSize: 11, letterSpacing: "0.3em", color: T.textFaint, textTransform: "uppercase", mb: 1 }}>
              ✦ Nuestra historia de amor ✦
            </Typography>

            <Typography sx={{ ...scriptFont, fontSize: { xs: 52, sm: 66 }, color: T.roseDark, lineHeight: 1, textShadow: `2px 4px 14px ${T.rose}28` }}>
              {novio}
            </Typography>
            <Box sx={{ display: "flex", alignItems: "center", gap: 2, justifyContent: "center", my: 0.5 }}>
              <Box sx={{ flex: 1, height: "0.5px", background: `linear-gradient(90deg, transparent, ${T.gold}80)` }} />
              <Typography sx={{ ...scriptFont, fontSize: 26, color: T.gold }}>&</Typography>
          ...
          <Box className="hs-reveal hs-reveal-2" sx={{ my: 4 }}>
            <Typography sx={{ ...serifFont, fontSize: 11, letterSpacing: "0.28em", color: T.textFaint, textTransform: "uppercase", textAlign: "center", mb: 1 }}>
              ✦ Un momento en movimiento ✦
            </Typography>
            <Typography sx={{ ...scriptFont, fontSize: 36, color: T.roseDark, textAlign: "center", lineHeight: 1, mb: 3 }}>
              Nuestro Video
            </Typography>
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Typography sx={{ ...serifFont, fontStyle: "italic", fontSize: 14, color: T.textMid, letterSpacing: "0.06em" }}>
          ...
          <Box className="hs-reveal hs-reveal-2" sx={{ my: 4 }}>
            ...
            <Box sx={{
              ...
              <Box sx={{ display: "flex", justifyContent: "center", mt: 3, gap: 1 }}>
                {[T.pinkFaint, T.rose, T.roseDark, T.rose, T.pinkFaint].map((c, i) => (
                  <HeartIcon key={i} sx={{ fontSize: 10 + i * 2 - Math.abs(i - 2) * 2, color: c || T.rose, opacity: 0.5 + i * 0.08 }} />
                ))}
              </Box>
            </Box>
          </Box>
          ...
          <Box className="hs-reveal hs-reveal-3" sx={{ my: 4 }}>
            ...
            <Typography sx={{ ...scriptFont, fontSize: { xs: 40, sm: 52 }, color: T.roseDark, textAlign: "center", lineHeight: 1, mb: 4 }}>
              Momentos Mágicos
            </Typography>
                ...
                return (
                  <Fade in key={index} timeout={800 + index * 200}>
                    <Box
                      ...
                      sx={{
                        background: "linear-gradient(160deg, #fffdf9 0%, #fdf8f0 100%)",
                        border: `1px solid ${T.border}`,
                        borderRadius: "22px",
                        overflow: "hidden",
                      ...
                      <Box sx={{ p: { xs: 3, sm: 4 } }}>
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 3 }}>
                          ...
                          <Box sx={{
                            ...
                            <IconComp sx={{ fontSize: 28, color: item.accent }} />
                          </Box>
                          ...
                          <Box sx={{ flex: 1 }}>
                            ...
                            <Box sx={{
                              ...
                              <Typography sx={{ ...serifFont, fontSize: 11, letterSpacing: "0.2em", color: item.accent, textTransform: "uppercase" }}>
                                {item.event}
                              </Typography>
                            </Box>
                            <Typography sx={{ ...scriptFont, fontSize: { xs: 28, sm: 36 }, color: T.roseDark, lineHeight: 1.1 }}>
                              {item.title}
                            </Typography>
                          </Box>
                        </Box>
                        ...
                        {/* Description */}
                        <Typography sx={{
                          ...serifFont, fontStyle: "italic",
                          fontSize: { xs: 15, sm: 16 },
                          color: T.textMid, lineHeight: 1.8,
                        ...
                        <Grid container spacing={1.5}>
                          {item.images.map((img, imgIdx) => (
                            <Grid key={imgIdx} size={{ xs: 12, sm: item.images.length === 1 ? 12 : 6 }}>
                              <Box
                                className="hs-photo"
                                onClick={() => handleImageClick(item.images, imgIdx)}
                                sx={{
                                  position: "relative",
                                  borderRadius: "16px",
                                  overflow: "hidden",
                                  ...
                                  aspectRatio: item.images.length === 1 ? "16/7" : "4/3",
                                }}
                              >
                                <Box
                                  component="img"
                                ...
                                <Box
                                  ...
                                  sx={{
                                    ...
                                    pb: 1.5, opacity: 0, transition: "opacity 0.3s",
                                  }}
                                >
                                  <HeartIcon sx={{ color: "#fff", fontSize: 26, animation: "hs-pulse 1.5s infinite" }} />
                                </Box>
                              </Box>
                            </Grid>
                          ))}
          ...
          {/* ── Closing ── */}
          <Box className="hs-reveal hs-reveal-4" sx={{ textAlign: "center", mt: 5 }}>
            <Ornament />
            <Typography sx={{ ...scriptFont, fontSize: { xs: 38, sm: 48 }, color: T.roseDark, lineHeight: 1, mt: 2 }}>
              Y así seguirá nuestra historia…
            </Typography>
            <Typography sx={{ ...serifFont, fontStyle: "italic", fontSize: 15, color: T.textMid, mt: 1.5, letterSpacing: "0.04em" }}>
          ...
          <Box sx={{ position: "relative", outline: "none", maxWidth: "90vw", maxHeight: "90vh" }}>
            {selectedImage && (
              <>
                  ...
                  <>
                    <IconButton
                      ...
                      sx={{
                        ...
                        "&:hover": { background: "rgba(0,0,0,0.65)" }, zIndex: 2,
                      }}
                    >
                      <ChevronLeftIcon />
                    </IconButton>
                ...
                {currentEventImages.length > 1 && (
                  <Box sx={{
                    display: "flex", justifyContent: "center", gap: 1, mt: 1.5,
                  }}>
                    {currentEventImages.map((_, idx) => (
                      <Box
                        key={idx}
                        onClick={() => { setCurrentImageIndex(idx); setSelectedImage(currentEventImages[idx]); }}
                        sx={{
